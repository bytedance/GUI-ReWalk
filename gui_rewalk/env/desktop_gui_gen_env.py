...
logger = logging.getLogger("deskguidata.env")
...
class DesktopGUIGenEnv(gym.Env):
    """
    DesktopGUIGenEnv with OpenAI Gym interface. It provides a desktop environment for setting and evaluating desktop automation tasks.
    """
    def __init__(
            self,
        ...
        try:
            ...
            assert action_space in ["computer_13", "pyautogui", "gen_data"]
